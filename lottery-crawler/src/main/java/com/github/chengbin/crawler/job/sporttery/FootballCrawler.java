...
import com.github.chengbin.common.utils.BeanUtils;
import com.github.chengbin.common.utils.StringUtils;
...
@Component
@Slf4j
public class FootballCrawler implements Crawler {
    ...
    @Autowired
    public FootballCrawler(IssueService issueService, FootballMatchService footballMatchService, FootballSpService footballSpService, FootballMatchParser footballMatchParser, FootballSpParser footballSpParser, FootballResultParser footballResultParser) {
        this.issueService = issueService;
        this.footballMatchService = footballMatchService;
        this.footballSpService = footballSpService;
        this.footballMatchParser = footballMatchParser;
        this.footballSpParser = footballSpParser;
        this.footballResultParser = footballResultParser;
    }
