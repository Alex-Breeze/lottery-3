...
public class IssueServiceImpl implements IssueService {
    ...
    public IssueDTO findByLotteryAndIssue(Integer lotteryId, String issue) {
        Issue issueDO = issueMapper.findByLotteryAndIssue(lotteryId, issue);
        IssueDTO issueDTO = new IssueDTO();
        CachedBeanCopier.copy(issueDO,issueDTO);
        return issueDTO;
    }
