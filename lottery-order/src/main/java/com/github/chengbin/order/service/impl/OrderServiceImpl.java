...
import com.github.chengbin.common.utils.IdWorker;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Autowired
    public OrderServiceImpl(LotteryFeign lotteryFeign, IssueFeign issueFeign, FootballFeign footballFeign, OrderMapper orderMapper) {
        this.lotteryFeign = lotteryFeign;
        this.issueFeign = issueFeign;
        this.footballFeign = footballFeign;
    ...
    public void checkLotteryIsSale(OrderForm orderForm) throws OrderException {
        LotteryDTO lottery = lotteryFeign.selectLotteryInfo(orderForm.getLotteryId());
        if(null == lottery){
    ...
    public void checkIssueIsOver(Integer lotteryId, String issue) throws OrderException {
        IssueDTO _issue = issueFeign.selectIssueInfo(lotteryId,issue);
        if(null == _issue){
